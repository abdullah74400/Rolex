...
BOT_TOKEN = environ.get('BOT_TOKEN', "6539733145:AAEAa-2FMQU54kxtwkHjY9kCCCJtGOXH-Po")
...
CODE = (environ.get('CODE', 'https://t.me/ak_backup_72/8'))

#stream link shortner
STREAM_SITE = (environ.get('STREAM_SITE', 'shortxlinks.com'))
STREAM_API = (environ.get('STREAM_API', '12e70a293a288f959126f3652544be0de3aac3e8'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001628897659')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '12e70a293a288f959126f3652544be0de3aac3e8')
